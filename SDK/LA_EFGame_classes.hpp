...
{
public:
	unsigned char                                      UnknownData00[0x240];                                     // 0x00B8(0x0240) MISSED OFFSET
...
// 0x0268 (0x0720 - 0x04B8)
class AEFGameInfo : public AGameInfo
{
public:
	unsigned long                                      bShowLikeMouseOver : 1;                                   // 0x04B8(0x0004) (Config)
	unsigned long                                      bNameTagAlpha : 1;                                        // 0x04B8(0x0004) (Config)
	unsigned long                                      bNameTagMonShowAll : 1;                                   // 0x04B8(0x0004) (Config)
	unsigned long                                      bIsPIE : 1;                                               // 0x04B8(0x0004)
	...
	TArray<class AActor*>                              IndicatorActors;                                          // 0x0700(0x0010) (Transient, NeedCtorLink)
	TArray<int>                                        IndicatorActorIndexPools;                                 // 0x0710(0x0010) (Transient, NeedCtorLink)
...
public:
	...
	unsigned long                                      bDefaultMeshHide : 1;                                     // 0x0590(0x0004)
	unsigned long                                      bRootMotionFallingCheck : 1;                              // 0x0590(0x0004) (DuplicateTransient)
	unsigned long                                      bCanDoFloorConform : 1;                                   // 0x0590(0x0004)
	unsigned long                                      bCanDoStepsSmoothing : 1;                                 // 0x0590(0x0004) (Edit)
	unsigned long                                      IsMatineePlay : 1;                                        // 0x0590(0x0004) (Transient)
	unsigned long                                      PhysFallingByAction : 1;                                  // 0x0590(0x0004) (Transient)
	unsigned long                                      bMergeAction : 1;                                         // 0x0590(0x0004) (Transient)
	unsigned long                                      bIgnoreBlockActors : 1;                                   // 0x0590(0x0004) (Transient)
	unsigned long                                      bEnableMaxRootMotionDistance : 1;                         // 0x0590(0x0004) (Transient)
	unsigned long                                      RootMotionBeHitControlHeight : 1;                         // 0x0590(0x0004) (Transient)
	unsigned long                                      bForceUniformVelocity : 1;                                // 0x0590(0x0004) (Transient)
	unsigned long                                      bNeedMoveChangedBase : 1;                                 // 0x0590(0x0004) (Transient)
	unsigned long                                      IsJustFinishedCinematicAnim : 1;                          // 0x0590(0x0004) (Transient)
	unsigned long                                      bUseDynamicFoliage : 1;                                   // 0x0590(0x0004)
	unsigned long                                      bValidCurrentFloorTypeCheck : 1;                          // 0x0590(0x0004) (Transient)
	unsigned long                                      bUseMeshMerge : 1;                                        // 0x0590(0x0004) (Const)
	unsigned long                                      bHideOnNextMeshMergeRequest : 1;                          // 0x0590(0x0004) (Transient)
	unsigned long                                      bDisableJumpOffPawn : 1;                                  // 0x0590(0x0004) (Transient)
	unsigned long                                      bGrabbed : 1;                                             // 0x0590(0x0004) (Transient)
	unsigned long                                      bIgnoreStartFalling : 1;                                  // 0x0590(0x0004) (Transient)
	unsigned long                                      bCinematicUnfixed : 1;                                    // 0x0590(0x0004) (Transient)
	unsigned long                                      bCinematicChangeAngularSpring : 1;                        // 0x0590(0x0004) (Transient)
	...
	TArray<int>                                        CinematicUnfixedBodyIndices;                              // 0x0884(0x0010) (Transient, NeedCtorLink)
...
{
public:
	class ULightEnvironmentComponent*                  PickupPropLightEnvironment;                               // 0x0894(0x0008) (ExportObject, Transient, Component, EditInline)
	int                                                PickupPropLightEnvironmentCount;                          // 0x089C(0x0004) (Transient)
	unsigned long                                      ControlledByTrackMove : 1;                                // 0x08A0(0x0004) (Transient)
	unsigned long                                      ControlledByTrackMoveOnServer : 1;                        // 0x08A0(0x0004) (Transient)
	float                                              TrackMoveStartPosition;                                   // 0x08A4(0x0004) (Transient)
	class AEFChangePlayerCameraVolume*                 ActivateCameraVolume;                                     // 0x08A8(0x0008) (Transient)
...
// 0x0010 (0x08A4 - 0x0894)
class AEFTransit : public AEFPawn
{
public:
	int                                                TransitIndex;                                             // 0x0894(0x0004) (Transient)
	struct FVector                                     CollisionBoxExtent;                                       // 0x0898(0x000C) (Transient)
...
// 0x0008 (0x089C - 0x0894)
class AEFVehicle : public AEFPawn
{
public:
	class AEFChangePlayerCameraVolume*                 ActivateCameraVolume;                                     // 0x0894(0x0008) (Transient)
...
public:
	...
	struct FEFAffinityInfo                             AffinityInfo;                                             // 0x03E0(0x0020) (Transient)
	TArray<struct FEFProjectileTimerData>              Timer;                                                    // 0x0400(0x0010) (Transient, NeedCtorLink)
	TArray<struct FEFProjectileAkEventData>            AkEventDatas;                                             // 0x0410(0x0010) (Transient, NeedCtorLink)
	class USkeletalMeshComponent*                      SkeletalMeshComponentData;                                // 0x0420(0x0008) (ExportObject, Transient, Component, EditInline)
	TArray<struct FEFProjectileMultiUseData>           SkeletalMeshMaterialParameterArray;                       // 0x0428(0x0010) (NeedCtorLink)
	int                                                FromSkillLV;                                              // 0x0438(0x0004) (Transient)
	int                                                FromSkillID;                                              // 0x043C(0x0004) (Transient)
	int                                                FromSkillStageIndex;                                      // 0x0440(0x0004) (Transient)
	int                                                FromEffectID;                                             // 0x0444(0x0004) (Transient)
	int                                                Tier[0x3];                                                // 0x0448(0x0004) (Transient)
	struct FEFProjectileCustomData                     CustomData;                                               // 0x0454(0x0018) (Transient)
	float                                              CycleHitLife;                                             // 0x046C(0x0004) (Transient)
	struct FVector                                     CycleHitBeforeLoc;                                        // 0x0470(0x000C) (Transient)
	struct FSet_Mirror                                 HittedCycleHitTargetList;                                 // 0x047C(0x0048) (Native, Transient)
	struct FVector                                     BeforeLocation;                                           // 0x04C4(0x000C) (Transient)
	TArray<class AEFParticleSkeletalMeshActor*>        ActionParticleSkeletalMeshActors;                         // 0x04D0(0x0010) (Transient, NeedCtorLink)
	TArray<int>                                        Lineage;                                                  // 0x04E0(0x0010) (AlwaysInit, NeedCtorLink)
...
{
public:
	int                                                SpawnedStartFX;                                           // 0x04F0(0x0004) (Transient)
	int                                                SpawnedStartDecalFX;                                      // 0x04F4(0x0004) (Transient)
	int                                                SpawnedLoopFX;                                            // 0x04F8(0x0004) (Transient)
	int                                                SpawnedLoopDecalFX;                                       // 0x04FC(0x0004) (Transient)
	struct FRotator                                    RandomRotate;                                             // 0x0500(0x000C) (Transient)
	unsigned long                                      PlayEndEffect : 1;                                        // 0x050C(0x0004) (Transient)
	float                                              LastRepeatTime;                                           // 0x0510(0x0004) (Transient)
	float                                              StartFXParticleOriginDrawScale;                           // 0x0514(0x0004) (Transient)
	float                                              StartDecalParticleOriginDrawScale;                        // 0x0518(0x0004) (Transient)
	float                                              LoopFXParticleOriginDrawScale;                            // 0x051C(0x0004) (Transient)
	float                                              LoopDecalParticleOriginDrawScale;                         // 0x0520(0x0004) (Transient)
	float                                              StartIndexDecalOriginDrawScale;                           // 0x0524(0x0004) (Transient)
	TArray<struct FEFSummonsFixAreaStartIndexDecal>    StartIndexDecalInfos;                                     // 0x0528(0x0010) (Transient, AlwaysInit, NeedCtorLink)
...
{
public:
	float                                              ExplodeUpperHeight;                                       // 0x04F0(0x0004) (Transient)
	float                                              TimeTilNextGravUpdate;                                    // 0x04F4(0x0004) (Transient)
...
{
public:
	int                                                MissileState;                                             // 0x04F0(0x0004) (Transient)
	int                                                SpawnedStartFX;                                           // 0x04F4(0x0004) (Transient)
	float                                              StartFXParticleOriginDrawScale;                           // 0x04F8(0x0004) (Transient)
	float                                              WaitTime;                                                 // 0x04FC(0x0004) (Transient)
	float                                              NoCollisionTime;                                          // 0x0500(0x0004) (Transient)
...
{
public:
	float                                              TargetSearchRadius;                                       // 0x04F0(0x0004) (Transient)
	float                                              TargetSearchStartTime;                                    // 0x04F4(0x0004) (Transient)
	float                                              TurnVelocity;                                             // 0x04F8(0x0004) (Transient)
	float                                              TargetSearchAngle;                                        // 0x04FC(0x0004) (Transient)
	unsigned long                                      bEnableTraceGiveUp : 1;                                   // 0x0500(0x0004) (Transient)
	unsigned long                                      bTargetChanged : 1;                                       // 0x0500(0x0004) (Transient)
	unsigned long                                      bTraceGiveUpFinish : 1;                                   // 0x0500(0x0004) (Transient)
	unsigned long                                      bEnableTraceDuration : 1;                                 // 0x0500(0x0004) (Transient)
	float                                              TraceGiveUpAngle;                                         // 0x0504(0x0004) (Transient)
	float                                              TraceGiveUpRadius;                                        // 0x0508(0x0004) (Transient)
	TEnumAsByte<ETraceProjectileState>                 TraceState;                                               // 0x050C(0x0001) (Transient)
	TEnumAsByte<ETraceProjectileTargetOptionType>      TraceTargetOption;                                        // 0x050D(0x0001) (Transient)
	unsigned char                                      UnknownData00[0x2];                                       // 0x050E(0x0002) MISSED OFFSET
	float                                              TraceDurationRemain;                                      // 0x0510(0x0004) (Transient)
	struct FVector                                     SyncMove;                                                 // 0x0514(0x000C) (Transient)
	float                                              AccumulatedSyncMoveDuration;                              // 0x0520(0x0004) (Transient)
...
// 0x008C (0x0964 - 0x08D8)
class UEFSkeletalMeshComponent : public USkeletalMeshComponent
{
public:
	unsigned long                                      bMeshHide : 1;                                            // 0x08D8(0x0004)
	unsigned long                                      bDynamicPhysicsParamEnable : 1;                           // 0x08D8(0x0004) (Transient)
	struct FEFDynamicPhysicsParam                      DynamicPhysicsParamInfo;                                  // 0x08DC(0x0018) (Transient)
	TArray<class UMaterialInterface*>                  DefaultMaterialsMIC;                                      // 0x08F4(0x0010) (Transient, NeedCtorLink)
	TArray<struct FEFMaterialVariation>                MaterialsVariation;                                       // 0x0904(0x0010) (Transient, NeedCtorLink)
	class USkeletalMesh*                               SkeletalMeshForSocket;                                    // 0x0914(0x0008) (Transient)
	unsigned char                                      UnknownData00[0x48];                                      // 0x091C(0x0048) UNKNOWN PROPERTY: MapProperty EFGame.EFSkeletalMeshComponent.SocketInfoMap
...
// 0x0048 (0x09AC - 0x0964)
class UEFMainSkelComponent : public UEFSkeletalMeshComponent
{
public:
	unsigned long                                      bDefaultMeshHide : 1;                                     // 0x0964(0x0004)
	int                                                LODIndexForPhysics;                                       // 0x0968(0x0004) (Transient)
	TArray<struct FName>                               PhysicsBoneListForPhysics;                                // 0x096C(0x0010) (Transient, NeedCtorLink)
	TArray<unsigned char>                              PhysicsBoneIndexListForPhysics;                           // 0x097C(0x0010) (Transient, NeedCtorLink)
	TArray<struct FName>                               RequiredBoneListForPhysics;                               // 0x098C(0x0010) (Transient, NeedCtorLink)
	TArray<struct FName>                               FixedBoneListForPhysics;                                  // 0x099C(0x0010) (Transient, NeedCtorLink)
...
// 0x00E4 (0x0A48 - 0x0964)
class UEFPartsSkelComponent : public UEFSkeletalMeshComponent
{
public:
	class AEFPawn*                                     ParentPawn;                                               // 0x0964(0x0008)
	struct FPointer                                    PartsMeshPointer;                                         // 0x096C(0x0008) (Native, Transient)
	struct FEFSocketGroup                              SocketGroup;                                              // 0x0974(0x0030) (NeedCtorLink)
	struct FName                                       AttachSocketName;                                         // 0x09A4(0x0008)
	class UAnimNodeSlot*                               CustomAnimNode;                                           // 0x09AC(0x0008)
	class UMorphNodeMultiPose*                         MorphNodePose;                                            // 0x09B4(0x0008)
	TArray<int>                                        DefaultParticleSystemList;                                // 0x09BC(0x0010) (AlwaysInit, NeedCtorLink)
	TArray<struct FPointer>                            DefaultParticleDataArray;                                 // 0x09CC(0x0010) (Const, Native, Transient, AlwaysInit)
	TArray<class UEFParticleData*>                     DefaultParticleDataArr;                                   // 0x09DC(0x0010) (Const, Transient, AlwaysInit, NeedCtorLink)
	TArray<int>                                        AttributeParticleSystemList;                              // 0x09EC(0x0010) (AlwaysInit, NeedCtorLink)
	TArray<class UEFParticleData*>                     AttributeParticleDataArr;                                 // 0x09FC(0x0010) (Transient, AlwaysInit, NeedCtorLink)
	TArray<int>                                        AttributeBaseDefaultParticleSpawnIndexArr;                // 0x0A0C(0x0010) (AlwaysInit, NeedCtorLink)
	TArray<struct FPointer>                            AttributeBaseDefaultParticleDataArray;                    // 0x0A1C(0x0010) (Const, Native, Transient, AlwaysInit)
	TArray<class UEFParticleData*>                     AttributeBaseDefaultParticleDataArr;                      // 0x0A2C(0x0010) (Transient, AlwaysInit, NeedCtorLink)
	float                                              TranslucencySortKeyFactor;                                // 0x0A3C(0x0004) (Transient)
	class UTexture*                                    AOTexture;                                                // 0x0A40(0x0008) (Transient)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFStaticMeshActor");
		return ptr;
	}
...
public:
	...
	struct FEFDMap_PathEngineData                      PathEngineData;                                           // 0x00AC(0x0020) (Edit)
	float                                              GlobalMaxDrawDistance;                                    // 0x00CC(0x0004) (Edit)
...
public:
	...
	struct FOverrideZoomStepInfo                       OverrideZoomStep;                                         // 0x0110(0x000C) (Transient)
	float                                              ChangeSkeletalMeshForceLODZoomDistance;                   // 0x011C(0x0004)
	int                                                ZoomOutAdditionSkeletalMeshForceLODIndex;                 // 0x0120(0x0004)
	TArray<float>                                      BoostFactorForMipmaps;                                    // 0x0124(0x0010) (Config, NeedCtorLink)
	int                                                CurrentZoomStep;                                          // 0x0134(0x0004) (Transient)
	float                                              InterpolationRatio;                                       // 0x0138(0x0004) (Config)
	float                                              ZoomOutInterpolationRatio;                                // 0x013C(0x0004) (Config)
	float                                              InZoomStepDiff;                                           // 0x0140(0x0004) (Transient)
	unsigned long                                      bUseLookAtBlend : 1;                                      // 0x0144(0x0004) (Config)
	unsigned long                                      bInitLookAtBlend : 1;                                     // 0x0144(0x0004) (Transient)
	unsigned long                                      bShowLookAtBlend : 1;                                     // 0x0144(0x0004) (Transient)
	float                                              LookAtBlendDiv;                                           // 0x0148(0x0004) (Config)
	float                                              LookAtBlendMul;                                           // 0x014C(0x0004) (Config)
	struct FVector                                     InterpLookAt;                                             // 0x0150(0x000C) (Transient)
	struct FVector                                     LastCenterPos;                                            // 0x015C(0x000C) (Transient)
	float                                              LastCameraInterpSpeedXY;                                  // 0x0168(0x0004) (Transient)
	float                                              LastCameraInterpSpeedZ;                                   // 0x016C(0x0004) (Transient)
	struct FVector                                     FixedLookAtPos;                                           // 0x0170(0x000C) (Transient)
	struct FFixedCameraInterpSpeed                     FixedCameraInterpInfo;                                    // 0x017C(0x000C) (Transient)
	int                                                CurrCamPostProcessID;                                     // 0x0188(0x0004)
	TEnumAsByte<EISOCamPPMethod>                       ChangePostProcessMethod;                                  // 0x018C(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x018D(0x0003) MISSED OFFSET
	float                                              CurrOverridePostProcessAlpha;                             // 0x0190(0x0004)
...
{
public:
	TEnumAsByte<ESelfCameraOpMode>                     OperationMode;                                            // 0x00F0(0x0001) (Transient)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00F1(0x0003) MISSED OFFSET
	struct FEFSelfCameraOpModeOption                   OperationModeOption;                                      // 0x00F4(0x003C) (Transient)
	struct FVector                                     StartCenterOffsetPos;                                     // 0x0130(0x000C) (Transient)
	float                                              StartViewRotYaw;                                          // 0x013C(0x0004) (Transient)
	float                                              StartViewRotPitch;                                        // 0x0140(0x0004) (Transient)
	float                                              StartZoomDist;                                            // 0x0144(0x0004) (Transient)
	float                                              StartFOV;                                                 // 0x0148(0x0004) (Transient)
	struct FVector                                     CurrentCenterOffsetPos;                                   // 0x014C(0x000C) (Transient)
	struct FVector                                     CurrentCenterPos;                                         // 0x0158(0x000C) (Transient)
	float                                              DesiredYaw;                                               // 0x0164(0x0004) (Transient)
	float                                              DesiredPitch;                                             // 0x0168(0x0004) (Transient)
	struct FVector                                     DesiredCenterPos;                                         // 0x016C(0x000C) (Transient)
	unsigned long                                      bMouseRotation : 1;                                       // 0x0178(0x0004) (Transient)
	unsigned long                                      bNeedActivate : 1;                                        // 0x0178(0x0004) (Transient)
	unsigned long                                      bChangeCameraPostProcessSetting : 1;                      // 0x0178(0x0004) (Transient)
	unsigned long                                      bChangeCameraFogSetting : 1;                              // 0x0178(0x0004) (Transient)
	unsigned long                                      bCollisionCameraView : 1;                                 // 0x0178(0x0004) (Transient)
	struct FEFSelfCameraDOFOption                      OverrideDOFOption;                                        // 0x017C(0x0014) (Transient)
	struct FPostProcessSettings                        CamPostProcessSettings;                                   // 0x0190(0x0174) (Transient, NeedCtorLink)
	struct FEFCameraOverrideFogSettings                CamFogSettings;                                           // 0x0304(0x0008) (Transient)
	struct FVector                                     CurrentTargetPos;                                         // 0x030C(0x000C) (Transient)
	struct FVector                                     LastTargetPos;                                            // 0x0318(0x000C) (Transient)
	float                                              ModifyCollisionCameraZoomDist;                            // 0x0324(0x0004) (Transient)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFSelfCamera");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFVolumeCamera");
		return ptr;
	}
...
public:
	...
	class UEFCameraBase*                               CurrentCamera;                                            // 0x06AC(0x0008) (Transient)
	class UEFCameraBase*                               LastCamera;                                               // 0x06B4(0x0008) (Transient)
	int                                                DefaultGameSkeletalMeshForceLOD;                          // 0x06BC(0x0004) (Transient)
	unsigned long                                      bUpdateOccludedActor : 1;                                 // 0x06C0(0x0004) (Transient)
	unsigned long                                      bUpdateTranslucentActor : 1;                              // 0x06C0(0x0004) (Transient)
	unsigned long                                      bDebugOccludedActorCollisionLine : 1;                     // 0x06C0(0x0004) (Transient)
	unsigned long                                      bRequiredClearBackupMatineeCamera : 1;                    // 0x06C0(0x0004) (Transient)
	unsigned long                                      bUseTargetBlend : 1;                                      // 0x06C0(0x0004) (Config)
	unsigned long                                      bPossessViewTargetChangeMode : 1;                         // 0x06C0(0x0004) (Transient)
	unsigned long                                      bUseVehicleFOVAngle : 1;                                  // 0x06C0(0x0004) (Transient)
	unsigned long                                      AllowWatchCameraZoomInOut : 1;                            // 0x06C0(0x0004) (Transient)
	float                                              OccludedActorBlendMaxTime;                                // 0x06C4(0x0004) (Transient)
	TArray<struct FOccludedActorInfo>                  OccludedStaticActors;                                     // 0x06C8(0x0010) (Transient, NeedCtorLink)
	TArray<struct FOccludedActorInfo>                  OccludedDynamicActors;                                    // 0x06D8(0x0010) (Transient, NeedCtorLink)
	float                                              fOccludedOutlineWidth;                                    // 0x06E8(0x0004) (Transient)
	float                                              fOccludedOutlineColorScale;                               // 0x06EC(0x0004) (Transient)
	struct FVector                                     vOccludedOutlineColor;                                    // 0x06F0(0x000C) (Transient)
	class ACameraActor*                                AttachCameraActor;                                        // 0x06FC(0x0008) (Transient)
	struct FVector                                     LastTargetLocation;                                       // 0x0704(0x000C) (Transient)
	class APawn*                                       OverTarget;                                               // 0x0710(0x0008) (Transient)
	TArray<struct FString>                             OverTargetList;                                           // 0x0718(0x0010) (Transient, NeedCtorLink)
	int                                                OverCurTargetIndex;                                       // 0x0728(0x0004) (Transient)
	class ACameraActor*                                OverBackupMatineeCamera;                                  // 0x072C(0x0008) (Transient)
	float                                              OverTargetBlendTime;                                      // 0x0734(0x0004) (Config)
	float                                              OverTargetBlendExp;                                       // 0x0738(0x0004) (Config)
	float                                              TargetBlendDiv;                                           // 0x073C(0x0004) (Config)
	float                                              TargetBlendMul;                                           // 0x0740(0x0004) (Config)
	struct FEFCameraOverrideFogSettings                CamOverrideFogSettings;                                   // 0x0744(0x0008) (Transient)
	float                                              CamOverrideFogAlpha;                                      // 0x074C(0x0004) (Transient)
	float                                              VehicleFOVAngle;                                          // 0x0750(0x0004) (Transient)
	int                                                CameraSettingID;                                          // 0x0754(0x0004) (Transient)
	int                                                CameraContentsSettingID;                                  // 0x0758(0x0004) (Transient)
...
{
public:
	unsigned long                                      bUseTargetCastLocation : 1;                               // 0x0050(0x0004) (Edit)
	unsigned long                                      bLocFromActorMesh : 1;                                    // 0x0050(0x0004) (Edit)
	unsigned long                                      bApplayScaleByCharge : 1;                                 // 0x0050(0x0004) (Edit)
	float                                              ParticlePlayRate;                                         // 0x0054(0x0004) (Edit)
	int                                                TranslucencySortPriority;                                 // 0x0058(0x0004) (Edit)
	float                                              ScalarScaleByCharge;                                      // 0x005C(0x0004) (Edit)
	struct FVector                                     VectorScaleByCharge;                                      // 0x0060(0x000C) (Edit)
	class UEFParticleData*                             ParticleData;                                             // 0x006C(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
...
public:
	...
	struct FVector                                     RelativeScale;                                            // 0x00E4(0x000C) (Edit)
	TArray<struct FParticleSysParam>                   ParticleSystemParamList;                                  // 0x00F0(0x0010) (Edit, Component, NeedCtorLink)
	class UEFParticleDataModuleSoundBase*              SoundModule;                                              // 0x0100(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	class UEFParticleDataModulePawnMaterialParam*      OwnerMaterialParamModule;                                 // 0x0108(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
...
public:
	unsigned char                                      UnknownData00[0x3];                                       // 0x0089(0x0003) MISSED OFFSET
	struct FString                                     EffectDesc;                                               // 0x008C(0x0010) (Edit, NeedCtorLink)
	struct FEFPPMEStatusValue                          StatusValue;                                              // 0x009C(0x000C) (Edit)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFSeqAct_ChangeTranslucentVolumeAction");
		return ptr;
	}
...
// 0x0031 (0x0295 - 0x0264)
class UEFSeqAct_Matinee : public USeqAct_Interp
{
public:
	class AActor*                                      Activator;                                                // 0x0264(0x0008) (Native, Transient)
	TArray<class UObject*>                             ObjListInGame;                                            // 0x026C(0x0010) (Transient, NeedCtorLink)
	int                                                MatineeIndex;                                             // 0x027C(0x0004) (Edit, EditConst)
	unsigned long                                      bSkipJump : 1;                                            // 0x0280(0x0004) (Edit)
	unsigned long                                      bUsingMuteEvent : 1;                                      // 0x0280(0x0004) (Edit)
	unsigned long                                      bUsingMuteEvent_WithoutAmbient : 1;                       // 0x0280(0x0004) (Edit)
	unsigned long                                      bIsApplyMuteEvent : 1;                                    // 0x0280(0x0004) (Transient)
	unsigned long                                      bNeedApplySkipSoundEvent : 1;                             // 0x0280(0x0004) (Transient)
	class UAkEvent*                                    SkipEffectSoundEvent;                                     // 0x0284(0x0008) (Edit)
	class UAkEvent*                                    SkipBGMEvent;                                             // 0x028C(0x0008) (Edit)
	TEnumAsByte<EFAutoBlendState>                      eAutoBlendState;                                          // 0x0294(0x0001) (Transient)
...
public:
	...
	struct FName                                       AnimListName;                                             // 0x0170(0x0008) (Edit)
	class UAnimNodeBlendList*                          AnimList;                                                 // 0x0178(0x0008)
	class UAnimNodeSequence*                           sAnimeNodeSeq;                                            // 0x0180(0x0008)
	class UAnimNodeSequence*                           eAnimeNodeSeq;                                            // 0x0188(0x0008)
	unsigned long                                      bForEverLoop : 1;                                         // 0x0190(0x0004) (Edit)
	unsigned long                                      isEventMove : 1;                                          // 0x0190(0x0004)
	unsigned long                                      isWaitTime : 1;                                           // 0x0190(0x0004)
	float                                              PosOffset;                                                // 0x0194(0x0004) (Edit)
	float                                              RandomPosOffset;                                          // 0x0198(0x0004) (Edit)
	TArray<struct FSNPC_MovingState>                   MovePoints;                                               // 0x019C(0x0010) (Edit, NeedCtorLink)
	TArray<struct FSNPC_MovingState>                   EventMovePoints;                                          // 0x01AC(0x0010) (Edit, NeedCtorLink)
	TEnumAsByte<EUNM_SNPC_workCompletedState>          emCompledted_Work;                                        // 0x01BC(0x0001) (Edit)
	TEnumAsByte<ENUM_SNPC_PlayAnimationName>           ewWaitAnimation;                                          // 0x01BD(0x0001) (Edit)
	TEnumAsByte<EUNM_SNPC_workCompletedState>          ewCompledted_Work;                                        // 0x01BE(0x0001) (Edit)
	TEnumAsByte<ENUM_SNPC_PlayAnimationName>           BackUpAnimName;                                           // 0x01BF(0x0001)
	TEnumAsByte<ENUM_SNPC_NPCState>                    EN_MoveState;                                             // 0x01C0(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x01C1(0x0003) MISSED OFFSET
	float                                              ewWaitTime;                                               // 0x01C4(0x0004) (Edit)
	float                                              ewBlendTime;                                              // 0x01C8(0x0004) (Edit)
	struct FString                                     ewForcedAnim;                                             // 0x01CC(0x0010) (Edit, NeedCtorLink)
	float                                              CheckWaitTime;                                            // 0x01DC(0x0004)
	int                                                BackUpCurrentCount;                                       // 0x01E0(0x0004)
	int                                                MainCount;                                                // 0x01E4(0x0004)
	int                                                CurrentCount;                                             // 0x01E8(0x0004)
	struct FSNPC_MovingState                           MainState;                                                // 0x01EC(0x0034) (NeedCtorLink)
	struct FVector                                     vC;                                                       // 0x0220(0x000C)
	struct FVector                                     vB;                                                       // 0x022C(0x000C)
	float                                              vD;                                                       // 0x0238(0x0004)
	float                                              CurrentTime;                                              // 0x023C(0x0004)
	struct FRotator                                    PendingRotator;                                           // 0x0240(0x000C)
	float                                              MainSPEED;                                                // 0x024C(0x0004)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFChangePlayerCameraVolume");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFDrawPlayerCameraVolumeComponent");
		return ptr;
	}
...
{
public:
	TArray<struct FEFUIIniStruct>                      EFUIIniList;                                              // 0x01E4(0x0010) (Config, NeedCtorLink)
	float                                              MinAppliedAdvanceTime;                                    // 0x01F4(0x0004)
	float                                              AppliedAdvanceTime;                                       // 0x01F8(0x0004)
	float                                              MaxAppliedAdvanceTime;                                    // 0x01FC(0x0004)
...
{
public:
	TArray<class UGFxObject*>                          GFxObjectBinding;                                         // 0x0200(0x0010) (Const, AlwaysInit, NeedCtorLink)
...
{
public:
	class UEFUISlotData*                               SlotData;                                                 // 0x00B4(0x0008)
...
{
public:
	class UEFGFxDataProvider*                          ListDataProvider;                                         // 0x00B4(0x0008) (Transient)
...
{
public:
	TArray<struct FSVariableInfo>                      VariableNameData;                                         // 0x00B4(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FGroupExtendedInfo>                  ExtendedInfo;                                             // 0x00B4(0x0010) (Config, NeedCtorLink)
...
{
public:
	TArray<struct FUIMailInfo>                         MailInfoArr;                                              // 0x00B4(0x0010) (NeedCtorLink)
	TArray<struct FMailReceiverCategory>               MailReceiverCategoryArr;                                  // 0x00C4(0x0010) (Config, NeedCtorLink)
	unsigned char                                      UnknownData00[0x48];                                      // 0x00D4(0x0048) UNKNOWN PROPERTY: MapProperty EFGame.EFGFxWidgetInteractionMail.MailReceiverIndexingList
...
{
public:
	unsigned long                                      OnlyModal : 1;                                            // 0x00B4(0x0004)
...
{
public:
	TArray<int>                                        ClassPreviewClassArr;                                     // 0x00B8(0x0010) (Transient, NeedCtorLink)
...
{
public:
	TArray<struct FCommonWidgetBinding>                CommonWidgetBindings;                                     // 0x00B8(0x0010) (NeedCtorLink)
...
{
public:
	int                                                UpValue1;                                                 // 0x00B8(0x0004) (Config)
	int                                                DownValuePerSec1;                                         // 0x00BC(0x0004) (Config)
	int                                                UpValue2;                                                 // 0x00C0(0x0004) (Config)
	int                                                DownValuePerSec2;                                         // 0x00C4(0x0004) (Config)
	int                                                UpValue3;                                                 // 0x00C8(0x0004) (Config)
	int                                                DownValuePerSec3;                                         // 0x00CC(0x0004) (Config)
	int                                                InputPower1;                                              // 0x00D0(0x0004) (Config)
	int                                                InputPower2;                                              // 0x00D4(0x0004) (Config)
	int                                                InputPower3;                                              // 0x00D8(0x0004) (Config)
	int                                                InputStamina1;                                            // 0x00DC(0x0004) (Config)
	int                                                InputStamina2;                                            // 0x00E0(0x0004) (Config)
	int                                                InputStamina3;                                            // 0x00E4(0x0004) (Config)
	int                                                MaxPower1;                                                // 0x00E8(0x0004) (Config)
	int                                                MaxPower2;                                                // 0x00EC(0x0004) (Config)
	int                                                MaxPower3;                                                // 0x00F0(0x0004) (Config)
...
{
public:
	class UEFGFxWidgetInteractionWarehouse*            InteractionWarehouse;                                     // 0x00B8(0x0008)
	class UEFGFxWidgetInteractionColosseum*            InteractionColosseum;                                     // 0x00C0(0x0008)
...
{
public:
	class UEFUIWindowContent*                          Content;                                                  // 0x00B8(0x0008)
...
public:
	...
	struct FEFRelativeTimeFadeInfo                     RelativeTimeFadeInfo;                                     // 0x01F4(0x002C) (NeedCtorLink)
	struct FMatrix                                     CachedViewProjectionMatrix;                               // 0x0220(0x0040) (Const, Native, Transient)
	struct FVector2D                                   CachedViewportSize;                                       // 0x0260(0x0008) (Const, Native, Transient)
	struct FQWord                                      CachedFrameNumber;                                        // 0x0268(0x0008) (Const, Native, Transient)
	int                                                CurrentMouseCursorPreset;                                 // 0x0270(0x0004) (Transient)
	TArray<struct FEFCursorPresetInfo>                 MouseCursorPreset;                                        // 0x0274(0x0010) (Native)
	int                                                CurrentMouseCursorSize;                                   // 0x0284(0x0004) (Transient)
...
public:
	...
	struct FString                                     strFullName;                                              // 0x0070(0x0010) (NeedCtorLink)
	TArray<struct FCustomizingMotionActionItem>        MotionActionArr;                                          // 0x0080(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	class UAnimSet*                                    FaceActionAnimSet;                                        // 0x0090(0x0008) (Edit)
	TArray<struct FCustomizingFaceActionItem>          FaceActionArr;                                            // 0x0098(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	struct FEFIconInfo                                 LeftEyeIcon;                                              // 0x00A8(0x0024) (Edit, NeedCtorLink)
	struct FEFIconInfo                                 RightEyeIcon;                                             // 0x00CC(0x0024) (Edit, NeedCtorLink)
	TArray<struct FCustomPartItemLook>                 arrCustomPartItemLook;                                    // 0x00F0(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	TArray<struct FCostumeDataSet>                     arrCostumeDataSet;                                        // 0x0100(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	struct FString                                     strCostumePreview;                                        // 0x0110(0x0010) (Edit, Transient, AlwaysInit, NeedCtorLink)
	class UAnimSet*                                    BoneMorphAnimset;                                         // 0x0120(0x0008) (Edit, Transient)
	TArray<struct FstBoneMorphGroup>                   arrBoneMorphTargetGroup;                                  // 0x0128(0x0010) (Edit, NeedCtorLink)
	TArray<struct FstBoneMorph>                        arrBoneMorphTarget;                                       // 0x0138(0x0010) (Edit, EditConst, NeedCtorLink)
	struct FObjectPath                                 PATH_BoneMorphAnimSet;                                    // 0x0148(0x0020) (NeedCtorLink)
	TArray<struct FBoneMorphAnimData>                  arrBoneMorphAnimData;                                     // 0x0168(0x0010) (AlwaysInit, NeedCtorLink)
	TArray<struct FstMeshMorphRule>                    arrMeshMorphRuleArray;                                    // 0x0178(0x0010) (Edit, NeedCtorLink)
	TArray<struct FstMaterialExpressionParameterGroup> arrMaterialExpressionParamGroup;                          // 0x0188(0x0010) (Edit, EditConst, NeedCtorLink)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFParticleSoundContainerEnhance");
		return ptr;
	}
...
public:
	...
	class UEFCameraViewShake*                          NewViewShake;                                             // 0x014C(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	class UEFParticleData*                             CameraEffect;                                             // 0x0154(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFParticleSoundDataEnhance");
		return ptr;
	}
...
public:
	...
	int                                                ApproachEvent_Distance;                                   // 0x00E4(0x0004) (Edit)
	class UAkEvent*                                    InteractionStartSound;                                    // 0x00E8(0x0008) (Edit)
	class UAkEvent*                                    InteractionEndSound;                                      // 0x00F0(0x0008) (Edit)
	class UAkEvent*                                    InteractionNextLinkSound;                                 // 0x00F8(0x0008) (Edit)
...
{
public:
	int                                                TriggerSkillEffectId;                                     // 0x0050(0x0004) (Edit)
	unsigned long                                      ActiveByMemoryPos : 1;                                    // 0x0054(0x0004) (Edit)
	unsigned long                                      FullRange : 1;                                            // 0x0054(0x0004) (Edit)
	unsigned long                                      Enable : 1;                                               // 0x0054(0x0004)
	unsigned long                                      PrivateTemplate : 1;                                      // 0x0054(0x0004) (Edit)
	unsigned long                                      OverwriteTemplate : 1;                                    // 0x0054(0x0004) (Edit)
	float                                              Time;                                                     // 0x0058(0x0004) (Edit)
	float                                              OriginalTime;                                             // 0x005C(0x0004)
	float                                              Duration;                                                 // 0x0060(0x0004) (Edit)
	TEnumAsByte<ECTE_NOTIFY_ACTIVATE_TYPE>             NotifyType;                                               // 0x0064(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0065(0x0003) MISSED OFFSET
	int                                                RepeatCount;                                              // 0x0068(0x0004) (Edit)
	float                                              RepeatTerm;                                               // 0x006C(0x0004) (Edit)
	struct FString                                     ToolTip;                                                  // 0x0070(0x0010) (Edit, NeedCtorLink)
	struct FString                                     NotifyName;                                               // 0x0080(0x0010) (Edit, NeedCtorLink)
	int                                                SortPriority;                                             // 0x0090(0x0004) (Transient)
	struct FColor                                      NotifyColor;                                              // 0x0094(0x0004)
	struct FString                                     GroupName;                                                // 0x0098(0x0010) (AlwaysInit, NeedCtorLink)
	TArray<struct FString>                             ViewGroupList;                                            // 0x00A8(0x0010) (NeedCtorLink)
	struct FPointer                                    TmpActionNotifyData;                                      // 0x00B8(0x0008) (Native, DuplicateTransient)
	int                                                Probability;                                              // 0x00C0(0x0004) (Edit)
...
{
public:
	unsigned long                                      bRemoveNotifyEnd : 1;                                     // 0x00C4(0x0004) (Edit)
	TArray<struct FEFAddStatusEffectByAbilityInfo>     ChangeToolInfo;                                           // 0x00C8(0x0010) (Edit, NeedCtorLink)
...
public:
	...
	unsigned long                                      bFollowActor : 1;                                         // 0x00CC(0x0004) (Edit)
	unsigned long                                      bStopWhenNotifyEnd : 1;                                   // 0x00CC(0x0004) (Edit)
	unsigned long                                      bMute : 1;                                                // 0x00CC(0x0004) (Edit)
	unsigned long                                      bStopWhenChangeAction : 1;                                // 0x00CC(0x0004) (Edit)
	struct FName                                       BoneName;                                                 // 0x00D0(0x0008) (Edit)
	float                                              StopWhenNotifyEndFadeTime;                                // 0x00D8(0x0004) (Edit)
	float                                              StopWhenChangeActionFadeTime;                             // 0x00DC(0x0004) (Edit)
	TEnumAsByte<EFActionNotifyFixSoundPosType>         FixSoundPosType;                                          // 0x00E0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00E1(0x0003) MISSED OFFSET
	float                                              AkEventDuration;                                          // 0x00E4(0x0004) (Edit)
	int                                                AkEventPlayingID;                                         // 0x00E8(0x0004) (Edit)
...
public:
	class UAkEvent*                                    AkEvent;                                                  // 0x00C4(0x0008) (Edit)
	unsigned long                                      bSwitchCharacterAKEvent : 1;                              // 0x00CC(0x0004) (Edit)
	struct FName                                       AttachBoneName;                                           // 0x00D0(0x0008) (Edit)
...
{
public:
	struct FName                                       anim_name;                                                // 0x00C4(0x0008) (Edit)
	int                                                MoveSpeed_Anim1;                                          // 0x00CC(0x0004) (Edit)
	struct FName                                       anim_name2;                                               // 0x00D0(0x0008) (Edit)
	int                                                MoveSpeed_Anim2;                                          // 0x00D8(0x0004) (Edit)
	struct FName                                       anim_name3;                                               // 0x00DC(0x0008) (Edit)
	int                                                MoveSpeed_Anim3;                                          // 0x00E4(0x0004) (Edit)
	struct FString                                     landstage_name;                                           // 0x00E8(0x0010) (Edit, NeedCtorLink)
	struct FEFAnimInfo                                 anim_info;                                                // 0x00F8(0x0030) (Edit)
	unsigned long                                      AnimErrorAlert : 1;                                       // 0x0128(0x0004) (Edit)
	unsigned long                                      DurationFitFromAni : 1;                                   // 0x0128(0x0004) (Edit)
	unsigned long                                      DurationFitFromStageEnd : 1;                              // 0x0128(0x0004) (Edit)
	unsigned long                                      StageDurationFitToEnd : 1;                                // 0x0128(0x0004) (Edit)
	unsigned long                                      ValidAnimName1 : 1;                                       // 0x0128(0x0004)
	unsigned long                                      ValidAnimName2 : 1;                                       // 0x0128(0x0004)
	unsigned long                                      ValidAnimName3 : 1;                                       // 0x0128(0x0004)
	struct FName                                       AnimName;                                                 // 0x012C(0x0008)
	float                                              StageRootMotionMoveDistance;                              // 0x0134(0x0004)
	float                                              StageRootMotionMaxMoveDistance;                           // 0x0138(0x0004)
...
{
public:
	unsigned long                                      WeaponMode : 1;                                           // 0x013C(0x0004) (Edit)
	unsigned long                                      IgnoreWeaponMode : 1;                                     // 0x013C(0x0004) (Edit)
	struct FName                                       stance00_anim_name;                                       // 0x0140(0x0008) (Edit)
	struct FName                                       stance01_anim_name;                                       // 0x0148(0x0008) (Edit)
	struct FName                                       stance02_anim_name;                                       // 0x0150(0x0008) (Edit)
	struct FName                                       stance03_anim_name;                                       // 0x0158(0x0008) (Edit)
...
{
public:
	float                                              BlendingTime;                                             // 0x00C4(0x0004) (Edit)
	float                                              DirDegreesPerSecond;                                      // 0x00C8(0x0004) (Edit)
	struct FName                                       AnimName_Front;                                           // 0x00CC(0x0008) (Edit)
	struct FName                                       AnimName_Back;                                            // 0x00D4(0x0008) (Edit)
	struct FName                                       AnimName_Left;                                            // 0x00DC(0x0008) (Edit)
	struct FName                                       AnimName_Right;                                           // 0x00E4(0x0008) (Edit)
...
{
public:
	TEnumAsByte<EPropState>                            ePropState;                                               // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	unsigned long                                      bLoopAnimation : 1;                                       // 0x00C8(0x0004) (Edit)
	unsigned long                                      bDespawnNotify : 1;                                       // 0x00C8(0x0004) (Edit)
...
{
public:
	TArray<struct FEFSkillEffectInfo>                  SkillEffectInfoList;                                      // 0x00C4(0x0010) (Edit, NeedCtorLink)
...
{
public:
	TEnumAsByte<EFCommonActionVoiceSetType>            CommonActionType;                                         // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	struct FString                                     Keyword;                                                  // 0x00C8(0x0010) (Edit, NeedCtorLink)
...
{
public:
	class UEFActionCondition*                          Condition;                                                // 0x00C4(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	int                                                ConditionOutputCount;                                     // 0x00CC(0x0004) (Edit)
	TArray<struct FString>                             ConditionOutputDesc;                                      // 0x00D0(0x0010) (Edit, NeedCtorLink)
...
{
public:
	TArray<int>                                        SelectDPIndexArr;                                         // 0x00C4(0x0010) (Edit, NeedCtorLink)
	unsigned long                                      bDeactivate : 1;                                          // 0x00D4(0x0004) (Edit)
	unsigned long                                      bActivate : 1;                                            // 0x00D4(0x0004) (Edit)
...
{
public:
	TEnumAsByte<EFEQUIP_PART>                          ePartsType;                                               // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	struct FVector                                     Velocity;                                                 // 0x00C8(0x000C) (Edit)
	class UParticleSystem*                             PSTemplate;                                               // 0x00D4(0x0008) (Edit)
	struct FName                                       SocketName;                                               // 0x00DC(0x0008) (Edit)
...
{
public:
	unsigned long                                      bUseOnlyLocalPlayer : 1;                                  // 0x00C4(0x0004) (Edit)
	unsigned long                                      RollBackOrigin : 1;                                       // 0x00C4(0x0004) (Edit)
	unsigned long                                      EndIsRelease : 1;                                         // 0x00C4(0x0004) (Edit)
	unsigned long                                      EnableBrightness : 1;                                     // 0x00C4(0x0004) (Edit)
	unsigned long                                      EnableLightColor : 1;                                     // 0x00C4(0x0004) (Edit)
	float                                              ChangeTime;                                               // 0x00C8(0x0004) (Edit)
	float                                              DirectionGuaranteeTime;                                   // 0x00CC(0x0004) (Edit)
	float                                              ReleaseTime;                                              // 0x00D0(0x0004) (Edit)
	float                                              Brightness;                                               // 0x00D4(0x0004) (Edit)
	struct FColor                                      LightColor;                                               // 0x00D8(0x0004) (Edit)
...
{
public:
	TEnumAsByte<EPARTICLE_SOUND_DOWN_DATA_TYPE>        ParticleDownType;                                         // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
...
public:
	TArray<struct FEFSkillEffectInfo>                  SkillEffectInfoList;                                      // 0x00C4(0x0010) (Edit, NeedCtorLink)
	struct FString                                     TestParticleSoundHittedKeyword;                           // 0x00D4(0x0010) (Edit, NeedCtorLink)
	class UEFParticleSoundContainerSkillHitSet*        TestUsedSkillHitSetContainer;                             // 0x00E4(0x0008) (Edit)
	TEnumAsByte<EFTestBuffMode>                        TestParticleSoundBuffMode;                                // 0x00EC(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00ED(0x0003) MISSED OFFSET
	struct FString                                     TestParticleSoundBuffKeyword;                             // 0x00F0(0x0010) (Edit, NeedCtorLink)
	float                                              TestParticleSoundBuffLifeTime;                            // 0x0100(0x0004) (Edit)
	float                                              TestParticleSoundBuffValue;                               // 0x0104(0x0004) (Edit)
...
{
public:
	struct FString                                     SignalString;                                             // 0x00C4(0x0010) (Edit, NeedCtorLink)
...
{
public:
	TEnumAsByte<ECommonActionAttachType>               AttachType;                                               // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	TArray<struct FPlaySkeletalMeshActor>              SkeletalMeshActors;                                       // 0x00C8(0x0010) (Edit, NeedCtorLink)
	struct FName                                       AttachName;                                               // 0x00D8(0x0008) (Edit)
	TArray<struct FEFChangeMeshInfo>                   ChangeMeshInfo;                                           // 0x00E0(0x0010) (Edit, NeedCtorLink)
	unsigned long                                      bNotifyEndDetach : 1;                                     // 0x00F0(0x0004) (Edit)
	struct FString                                     strAttachToolLookInfo;                                    // 0x00F4(0x0010) (Edit, NeedCtorLink)
	TArray<struct FEFChageToolByAbilityInfo>           ChangeToolInfo;                                           // 0x0104(0x0010) (Edit, NeedCtorLink)
...
{
public:
	int                                                FootDown;                                                 // 0x00C4(0x0004) (Edit)
	TArray<struct FString>                             ParticleAttachBoneName;                                   // 0x00C8(0x0010) (Edit, NeedCtorLink)
	TArray<struct FString>                             ParticleAttachSoketName;                                  // 0x00D8(0x0010) (Edit, NeedCtorLink)
...
{
public:
	int                                                GameNoteTableIndex;                                       // 0x00C4(0x0004) (Edit)
...
{
public:
	unsigned long                                      HidePawn : 1;                                             // 0x00C4(0x0004) (Edit)
	unsigned long                                      bWeaponTypeIgnoresGadget : 1;                             // 0x00C4(0x0004) (Edit)
	unsigned long                                      bHideBaseMeshWithFX : 1;                                  // 0x00C4(0x0004) (Edit)
	unsigned long                                      bExecuteNotifyEnd : 1;                                    // 0x00C4(0x0004) (Edit)
	TArray<struct FHideInfoUnit>                       sHideInfoUnitArr;                                         // 0x00C8(0x0010) (Edit, AlwaysInit, NeedCtorLink)
...
{
public:
	unsigned long                                      MakeParts : 1;                                            // 0x00C4(0x0004) (Edit)
	unsigned long                                      FailCompleteCancel : 1;                                   // 0x00C4(0x0004) (Edit)
	int                                                changeStance;                                             // 0x00C8(0x0004) (Edit)
...
{
public:
	struct FInputTimingInfo                            InputTiming;                                              // 0x00C4(0x0028) (Edit, NeedCtorLink)
	TArray<int>                                        StartHotKeyIdArray;                                       // 0x00EC(0x0010) (NeedCtorLink)
	unsigned long                                      TriggerDelayMoveCancel : 1;                               // 0x00FC(0x0004)
	unsigned long                                      TriggerMoveCancel : 1;                                    // 0x00FC(0x0004)
	unsigned long                                      TriggerDelaySkillCancel : 1;                              // 0x00FC(0x0004)
	unsigned long                                      TriggerSkillCancel : 1;                                   // 0x00FC(0x0004)
	unsigned long                                      TriggerMoveDirInput : 1;                                  // 0x00FC(0x0004)
	unsigned long                                      TriggerSkillDirInput : 1;                                 // 0x00FC(0x0004)
...
{
public:
	unsigned long                                      bHideNotifyEnd : 1;                                       // 0x00C4(0x0004) (Edit)
...
{
public:
	TEnumAsByte<EProfessionType>                       LifeToolType;                                             // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	unsigned long                                      bHideNotifyEnd : 1;                                       // 0x00C8(0x0004) (Edit)
...
{
public:
	TEnumAsByte<EFActionNotify_LookTarget_Type>        LookType;                                                 // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	float                                              InterpolationTime;                                        // 0x00C8(0x0004) (Edit)
...
{
public:
	TEnumAsByte<EMemoryPosType>                        eMemoryPosType;                                           // 0x00C4(0x0001) (Edit)
...
{
public:
	TArray<int>                                        OutputStageIndex;                                         // 0x00C4(0x0010) (Edit, Const, EditFixedSize, NeedCtorLink)
	TArray<struct FString>                             OutputStageDesc;                                          // 0x00D4(0x0010) (Edit, Const, EditConst, NeedCtorLink)
...
{
public:
	int                                                StatusEffectId;                                           // 0x00E4(0x0004) (Edit)
	int                                                MinAngle;                                                 // 0x00E8(0x0004) (Edit)
	int                                                MaxAngle;                                                 // 0x00EC(0x0004) (Edit)
	int                                                MaxDistance;                                              // 0x00F0(0x0004) (Edit)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFActionNotify_MonsterMoveNextStageConditionChangeTarget");
		return ptr;
	}
...
{
public:
	unsigned long                                      ANDOperation : 1;                                         // 0x00E4(0x0004) (Edit)
	TArray<struct FEFCheckAreaInfo>                    AreaInfos;                                                // 0x00E8(0x0010) (Edit, NeedCtorLink)
...
{
public:
	int                                                ProbabilityValue;                                         // 0x00E4(0x0004) (Edit)
...
{
public:
	TArray<int>                                        SkillEffectId;                                            // 0x00E4(0x0010) (Edit, NeedCtorLink)
...
{
public:
	TEnumAsByte<EStatusEffectTargetCheckType>          TargetType;                                               // 0x00E4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00E5(0x0003) MISSED OFFSET
	int                                                StatusEffectId;                                           // 0x00E8(0x0004) (Edit)
	int                                                Count;                                                    // 0x00EC(0x0004) (Edit)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
        if (!ptr) 
           ptr = UObject::FindClass("Class EFGame.EFActionNotify_MonsterMoveNextStageConditionStatusEffect");
		return ptr;
	}
...
{
public:
	TArray<int>                                        LimbIdArray;                                              // 0x00C4(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	unsigned long                                      LimbHitEnabled : 1;                                       // 0x00D4(0x0004) (Edit)
	struct FEFPartsHighlightInfo                       PartsHighlightInfo;                                       // 0x00D8(0x0030) (Edit)
...
{
public:
	TEnumAsByte<EFActionNotify_NPCSkillMoveType>       MoveType;                                                 // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	float                                              MoveSpeed;                                                // 0x00C8(0x0004) (Edit)
	float                                              TargetingCycleTime;                                       // 0x00CC(0x0004) (Edit)
	float                                              PursuitSightDegree;                                       // 0x00D0(0x0004) (Edit)
	float                                              PursuitRange;                                             // 0x00D4(0x0004) (Edit)
	float                                              MoveDegree;                                               // 0x00D8(0x0004) (Edit)
...
{
public:
	TEnumAsByte<ENpcStatus>                            NpcStatusType;                                            // 0x00C4(0x0001) (Edit)
...
{
public:
	unsigned long                                      bActive : 1;                                              // 0x00C4(0x0004) (Edit)
...
{
public:
	struct FString                                     ControlNotifyName;                                        // 0x00C4(0x0010) (Edit, NeedCtorLink)
...
{
public:
	int                                                WeaponFXIndex;                                            // 0x00C4(0x0004) (Edit)
...
public:
	TEnumAsByte<EFEQUIP_PART>                          ePartsType;                                               // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	int                                                iPartsIndex;                                              // 0x00C8(0x0004) (Edit)
...
{
public:
	unsigned long                                      bActionType : 1;                                          // 0x00C4(0x0004) (Edit)
	struct FMaterialChangeUnit                         sUnit;                                                    // 0x00C8(0x0018) (Edit, NeedCtorLink)
	TArray<struct FMaterialLookChangeUnit>             sUnitArr;                                                 // 0x00E0(0x0010) (Edit, NeedCtorLink)
...
// 0x0090 (0x0154 - 0x00C4)
class UEFActionNotify_PawnMaterialParam : public UEFAction_Notify
{
public:
	unsigned long                                      bActionType : 1;                                          // 0x00C4(0x0004) (Edit)
	struct FMaterialParamUnit                          sUnit;                                                    // 0x00C8(0x007C) (Edit, NeedCtorLink)
	TArray<struct FMaterialLookParamUnit>              sUnitArr;                                                 // 0x0144(0x0010) (Edit, NeedCtorLink)
...
{
public:
	TEnumAsByte<EPhysics>                              StartPhysics;                                             // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	unsigned long                                      bRestorePrevPhysics : 1;                                  // 0x00C8(0x0004) (Edit)
...
{
public:
	struct FPhysicsParam                               Param;                                                    // 0x00C4(0x0028) (Edit, NeedCtorLink)
...
// 0x01AC (0x0270 - 0x00C4)
class UEFActionNotify_PlayBeamEffect : public UEFAction_Notify
{
public:
	unsigned long                                      bSkipIfOwnerIsHidden : 1;                                 // 0x00C4(0x0004) (Edit)
	unsigned long                                      bIgnoreAnimRate : 1;                                      // 0x00C4(0x0004)
	struct FEFParticleSystemInfo                       PSInfo;                                                   // 0x00C8(0x0158) (Component, NeedCtorLink, Deprecated)
	class UEFActionParticleData*                       ActionParticleData;                                       // 0x0220(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	struct FString                                     SyncSkillEffectNotify;                                    // 0x0228(0x0010) (NeedCtorLink)
	struct FEFBeamActionParam                          SourceInfo;                                               // 0x0238(0x0018) (Edit)
	struct FEFBeamActionParam                          TargetInfo;                                               // 0x0250(0x0018) (Edit)
	class UEFBeamActionBase*                           BeamAction;                                               // 0x0268(0x0008) (Edit, EditInline)
...
{
public:
	unsigned long                                      bUseOnlyLocalPlayer : 1;                                  // 0x00C4(0x0004)
	unsigned long                                      bIgnoreAnimRate : 1;                                      // 0x00C4(0x0004)
	class UParticleSystem*                             CameraParticle;                                           // 0x00C8(0x0008) (Edit)
	float                                              CameraOffset;                                             // 0x00D0(0x0004) (Edit)
	struct FRotator                                    ParticleRotation;                                         // 0x00D4(0x000C) (Edit)
	struct FVector                                     ParticleSize3D;                                           // 0x00E0(0x000C) (Edit)
	TArray<struct FParticleSysParam>                   ParticleSystemParamList;                                  // 0x00EC(0x0010) (Edit, Component, NeedCtorLink)
	int                                                ActionParticleId;                                         // 0x00FC(0x0004) (Edit)
	TEnumAsByte<EACTION_PARTICLE_DATA_TYPE>            ActionParticleDataType;                                   // 0x0100(0x0001) (Edit)
...
{
public:
	int                                                DecalTableIndex;                                          // 0x00C4(0x0004) (Edit)
	unsigned long                                      bPlayActionAgentDecal : 1;                                // 0x00C8(0x0004) (Edit)
	unsigned long                                      OffsetIsTargetPosition : 1;                               // 0x00C8(0x0004) (Edit)
	unsigned long                                      bUsingRootMotionAffectedOffset : 1;                       // 0x00C8(0x0004) (Edit)
	unsigned long                                      AutoDirectionAngle : 1;                                   // 0x00C8(0x0004) (Edit)
	unsigned long                                      bOnlyLocalPlayer : 1;                                     // 0x00C8(0x0004) (Edit)
	unsigned long                                      bFrontTarget : 1;                                         // 0x00C8(0x0004) (Edit)
	unsigned long                                      ForcedOutput : 1;                                         // 0x00C8(0x0004) (Edit)
	float                                              OffsetX;                                                  // 0x00CC(0x0004) (Edit)
	float                                              OffsetY;                                                  // 0x00D0(0x0004) (Edit)
	float                                              SizeWidth;                                                // 0x00D4(0x0004) (Edit)
	float                                              SizeHeight;                                               // 0x00D8(0x0004) (Edit)
	float                                              DecalDirectionAngle;                                      // 0x00DC(0x0004) (Edit)
	int                                                SkillEffectId;                                            // 0x00E0(0x0004) (Edit)
	int                                                EffectAngle;                                              // 0x00E4(0x0004) (Edit)
	...
	struct FLinearColor                                DecalColor;                                               // 0x00FC(0x0010) (Edit)
...
// 0x00AC (0x0170 - 0x00C4)
class UEFActionNotify_PlayParticleEffect : public UEFAction_Notify
{
public:
	unsigned long                                      bPlayOnlyFirstLoop : 1;                                   // 0x00C4(0x0004) (Edit)
	unsigned long                                      bUseOnlyLocalPlayer : 1;                                  // 0x00C4(0x0004) (Edit)
	unsigned long                                      bOriginScale : 1;                                         // 0x00C4(0x0004) (Edit)
	unsigned long                                      bCharge : 1;                                              // 0x00C4(0x0004) (Edit)
	unsigned long                                      bSkillEndDetach : 1;                                      // 0x00C4(0x0004) (Edit)
	unsigned long                                      bSkipIfOwnerIsHidden : 1;                                 // 0x00C4(0x0004) (Edit)
	unsigned long                                      bIgnoreAnimRate : 1;                                      // 0x00C4(0x0004)
	unsigned long                                      bFloorCheck : 1;                                          // 0x00C4(0x0004) (Edit)
	unsigned long                                      bUseRandomTransform : 1;                                  // 0x00C4(0x0004) (Edit)
	int                                                AbilityTypeCondition;                                     // 0x00C8(0x0004) (Edit)
	TArray<int>                                        AbilityTypeConditionNotExistArray;                        // 0x00CC(0x0010) (Edit, NeedCtorLink)
	TEnumAsByte<ECommonActionEffectType>               CommonActionEffectTypeCondition;                          // 0x00DC(0x0001) (Edit)
	TEnumAsByte<ECommonActionEffectType>               CommonActionEffectTypeConditionNotExist;                  // 0x00DD(0x0001) (Edit)
	TEnumAsByte<EACTION_PARTICLE_DATA_TYPE>            ActionParticleDataType;                                   // 0x00DE(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x1];                                       // 0x00DF(0x0001) MISSED OFFSET
	struct FString                                     SyncPosSkillEffectNotifyName;                             // 0x00E0(0x0010) (NeedCtorLink)
	int                                                ActionParticleId;                                         // 0x00F0(0x0004) (Edit)
	struct FVector                                     StartTimePawnLocation;                                    // 0x00F4(0x000C)
	class UEFActionParticleData*                       ParticleData;                                             // 0x0100(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	TArray<class UEFParticleDataModifier*>             PSLookSet;                                                // 0x0108(0x0010) (Edit, ExportObject, NeedCtorLink, EditInline)
	TArray<struct FEFActionPSFloorInfo>                PSFloorSet;                                               // 0x0118(0x0010) (Edit, EditFixedSize, EditConst, NeedCtorLink)
	struct FEFPSRandomVector                           RandomTransformLocation;                                  // 0x0128(0x0018) (Edit)
	struct FEFPSRandomRotator                          RandomTransformRotation;                                  // 0x0140(0x0018) (Edit)
	struct FEFPSRandomVector                           RandomTransformScale;                                     // 0x0158(0x0018) (Edit)
...
{
public:
	struct FString                                     SuccessMovieName;                                         // 0x00C4(0x0010) (Edit, NeedCtorLink)
	struct FString                                     GreatSuccessMovieName;                                    // 0x00D4(0x0010) (Edit, NeedCtorLink)
	struct FString                                     FailMovieName;                                            // 0x00E4(0x0010) (Edit, NeedCtorLink)
	unsigned long                                      bHideNotifyEnd : 1;                                       // 0x00F4(0x0004) (Edit)
...
public:
	...
	unsigned long                                      bPlayActionAgentDecal : 1;                                // 0x00C8(0x0004) (Edit)
	unsigned long                                      ForcedOutput : 1;                                         // 0x00C8(0x0004) (Edit)
	int                                                SkillEffectId;                                            // 0x00CC(0x0004) (Edit)
	int                                                ProjectileSkillEffectId;                                  // 0x00D0(0x0004) (Edit)
	float                                              AdjustSize;                                               // 0x00D4(0x0004) (Edit)
	float                                              DecalBlendInTime;                                         // 0x00D8(0x0004) (Edit)
	float                                              DecalScaleTime;                                           // 0x00DC(0x0004) (Edit)
	float                                              DecalFillTime;                                            // 0x00E0(0x0004) (Edit)
	float                                              DecalBlendOutTime;                                        // 0x00E4(0x0004) (Edit)
...
{
public:
	class UEFAN_Params*                                dummy01;                                                  // 0x00C4(0x0008) (ExportObject, NeedCtorLink, EditInline)
	class UEFActionNotify_AnimEvent*                   dummy02;                                                  // 0x00CC(0x0008) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bSkipIfOwnerIsHidden : 1;                                 // 0x00D4(0x0004) (Edit)
	unsigned long                                      SpawnFromMouseTargetPos : 1;                              // 0x00D4(0x0004) (Edit)
	unsigned long                                      bIgnoreAnimRate : 1;                                      // 0x00D4(0x0004)
	TArray<struct FPlaySkeletalMeshActor>              SkeletalMeshActors;                                       // 0x00D8(0x0010) (Edit, NeedCtorLink)
	float                                              RootMotionScaleBaseDist;                                  // 0x00E8(0x0004) (Edit)
	struct FName                                       AttachName;                                               // 0x00EC(0x0008) (Edit)
	class UDynamicLightEnvironmentComponent*           LightEnvironment;                                         // 0x00F4(0x0008) (ExportObject, Component, EditInline)
...
{
public:
	unsigned long                                      ApplyWhenChangeAction : 1;                                // 0x00C4(0x0004) (Edit)
	struct FString                                     ActionNotifyTag;                                          // 0x00C8(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	struct FActionNotify_SM_AnimEventData              AnimEventData;                                            // 0x00D8(0x0038) (Edit, NeedCtorLink)
...
public:
	unsigned long                                      bUseOnlyLocalPlayer : 1;                                  // 0x00C4(0x0004) (Edit)
	unsigned long                                      bStageEndClear : 1;                                       // 0x00C4(0x0004) (Edit)
	class UPostProcessChain*                           PPChain;                                                  // 0x00C8(0x0008) (Edit)
	class UPostProcessChain*                           PPChain_Clone;                                            // 0x00D0(0x0008)
	class UEFPostProcessMaterialEffectSkill*           PostProcessMaterialData;                                  // 0x00D8(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
...
public:
	TEnumAsByte<EFEQUIP_PART>                          ePartsType;                                               // 0x00C4(0x0001) (Edit)
	TEnumAsByte<EFSOCKET_STATE>                        eSocketState;                                             // 0x00C5(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFActionNotify_Rotate_Type>            LookType;                                                 // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	float                                              Degree;                                                   // 0x00C8(0x0004) (Edit)
...
{
public:
	int                                                NpcId;                                                    // 0x00C4(0x0004) (Edit)
	struct FString                                     NpcSignal;                                                // 0x00C8(0x0010) (Edit, NeedCtorLink)
...
{
public:
	struct FString                                     AttachBoneName;                                           // 0x00C4(0x0010) (Edit, NeedCtorLink)
...
{
public:
	TEnumAsByte<EFSoundSetStuffType>                   StuffType;                                                // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EACTION_PARTICLE_DATA_TYPE>            ActionParticleDataType;                                   // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	int                                                ActionParticleId;                                         // 0x00C8(0x0004) (Edit)
...
{
public:
	TEnumAsByte<ESuperArmorType>                       SuperArmorTypeValue;                                      // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	unsigned long                                      bShowEffect : 1;                                          // 0x00C8(0x0004) (Edit)
...
{
public:
	float                                              StartDistance;                                            // 0x00C4(0x0004) (Edit)
	float                                              EndDistance;                                              // 0x00C8(0x0004) (Edit)
	int                                                Rotation;                                                 // 0x00CC(0x0004) (Edit)
	struct FString                                     ControlDecalNotifyName;                                   // 0x00D0(0x0010) (Edit, NeedCtorLink)
...
{
public:
	unsigned long                                      bCollide : 1;                                             // 0x00C4(0x0004) (Edit)
...
{
public:
	unsigned long                                      bForceRemovePreviousEffect : 1;                           // 0x00C4(0x0004) (Edit)
	unsigned long                                      bStopWhenNotifyEnd : 1;                                   // 0x00C4(0x0004) (Edit)
	unsigned long                                      bForceChildAllRemove : 1;                                 // 0x00C4(0x0004) (Edit)
	unsigned long                                      bUseOnlyLocalPlayer : 1;                                  // 0x00C4(0x0004) (Edit)
	float                                              TrailDuration;                                            // 0x00C8(0x0004) (Edit)
	float                                              TrailDeltaSecondsBetweenChildren;                         // 0x00CC(0x0004) (Edit)
	float                                              TrailPerChildLifetime;                                    // 0x00D0(0x0004) (Edit)
	float                                              InitialAlphaValue;                                        // 0x00D4(0x0004) (Edit)
	float                                              InitialAlphaDuration;                                     // 0x00D8(0x0004) (Edit)
	float                                              SourceColorIntensity;                                     // 0x00DC(0x0004) (Edit)
	struct FColor                                      AmbientGlowColorS;                                        // 0x00E0(0x0004) (Edit)
	struct FColor                                      AmbientGlowColorE;                                        // 0x00E4(0x0004) (Edit)
	struct FColor                                      RimLightColorS;                                           // 0x00E8(0x0004) (Edit)
	struct FColor                                      RimLightColorE;                                           // 0x00EC(0x0004) (Edit)
...
{
public:
	TEnumAsByte<EFEQUIP_PART>                          TrailParts;                                               // 0x00C4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C5(0x0003) MISSED OFFSET
	int                                                TrailPartsIndex;                                          // 0x00C8(0x0004) (Edit)
	class UAnimNotify_Trails*                          AnimTrails;                                               // 0x00CC(0x0008) (ExportObject, NeedCtorLink, EditInline)
	class UEFData_AnimNotify_Trails*                   AnimNotifyTrailsData;                                     // 0x00D4(0x0008) (Edit)
	TArray<class UEFParticleDataModifier*>             TrailLookSet;                                             // 0x00DC(0x0010) (Edit, ExportObject, NeedCtorLink, EditInline)
	class UParticleSystem*                             PSTemplate;                                               // 0x00EC(0x0008) (Edit)
	TArray<struct FParticleSysParam>                   DefaultTrailParamList;                                    // 0x00F4(0x0010) (Edit, Component, NeedCtorLink)
	unsigned long                                      bSetTemplate : 1;                                         // 0x0104(0x0004)
	int                                                TrailSampledDataCount;                                    // 0x0108(0x0004) (Edit, EditConst)
	float                                              DistanceTessellationStepSize;                             // 0x010C(0x0004) (Edit)
...
{
public:
	unsigned long                                      bInstant : 1;                                             // 0x00C4(0x0004) (Edit)
	unsigned long                                      bSyncAnimEnd : 1;                                         // 0x00C4(0x0004) (Edit)
	unsigned long                                      bChangeStageServer : 1;                                   // 0x00C4(0x0004) (Edit)
	int                                                NextStageIndex;                                           // 0x00C8(0x0004) (Edit)
	int                                                UIUnitIndex;                                              // 0x00CC(0x0004) (Edit)
	TEnumAsByte<EActionNotifyUIEventKey>               UIEventKey;                                               // 0x00D0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00D1(0x0003) MISSED OFFSET
	int                                                SendServerSuccessValue;                                   // 0x00D4(0x0004) (Edit)
...
public:
	unsigned long                                      bUseOnlyLocalPlayer : 1;                                  // 0x00C4(0x0004) (Edit)
	unsigned long                                      bIgnoreAnimRate : 1;                                      // 0x00C4(0x0004)
	unsigned long                                      StopShakeOnNotifyEnd : 1;                                 // 0x00C4(0x0004) (Edit)
	unsigned long                                      ViewShakeSpawn : 1;                                       // 0x00C4(0x0004)
	float                                              SkipDistance;                                             // 0x00C8(0x0004) (Edit)
	TArray<struct FString>                             ExceptLookInfoSet;                                        // 0x00CC(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	class UEFCameraViewShake*                          NewViewShake;                                             // 0x00DC(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	class UEFCameraViewShakeAnim*                      NewViewShakeAnim;                                         // 0x00E4(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	struct FString                                     ViewShakePrefix;                                          // 0x00EC(0x0010) (NeedCtorLink)
...
{
public:
	TEnumAsByte<EFVoiceSetAdditionalType>              AdditionalType;                                           // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetAttackCastType>              AttackCastType;                                           // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetAttackCastLongType>          AttackCastLongType;                                       // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetAttackExecType>              AttackExecType;                                           // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetAttackShotType>              AttackShotType;                                           // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetDamageType>                  DamageType;                                               // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetDeathType>                   DeathType;                                                // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetDownType>                    DownType;                                                 // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetIdleType>                    IdleType;                                                 // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetRunType>                     RunType;                                                  // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetSpawnType>                   SpawnType;                                                // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetStandUpType>                 StandUpType;                                              // 0x00C4(0x0001) (Edit)
...
{
public:
	TEnumAsByte<EFVoiceSetWalkType>                    WalkType;                                                 // 0x00C4(0x0001) (Edit)
...
public:
	unsigned long                                      bExecuteNotifyEnd : 1;                                    // 0x00C4(0x0004) (Edit)
	TArray<int>                                        WeapeonSubIdArr;                                          // 0x00C8(0x0010) (Edit, AlwaysInit, NeedCtorLink)
...
{
public:
	unsigned long                                      EquipWhenStart : 1;                                       // 0x00C4(0x0004) (Edit)
...
public:
	...
	int                                                ActionId;                                                 // 0x0054(0x0004) (Edit)
	struct FString                                     ActionName;                                               // 0x0058(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	unsigned long                                      MergeActionStage : 1;                                     // 0x0068(0x0004)
	unsigned long                                      LayerMergeActionStage : 1;                                // 0x0068(0x0004) (Edit, Transient)
	unsigned long                                      LayerZeroExtentLineCheck : 1;                             // 0x0068(0x0004) (Edit, Transient)
	unsigned long                                      bSetPerfectZoneInfo : 1;                                  // 0x0068(0x0004)
	TArray<struct FNpcPartInfo>                        NpcPartInfoArray;                                         // 0x006C(0x0010) (Edit, DuplicateTransient, NeedCtorLink)
	TArray<struct FEFStageLayer>                       StageLayerList;                                           // 0x007C(0x0010) (AlwaysInit, NeedCtorLink)
	int                                                LayerIndex;                                               // 0x008C(0x0004) (Edit, Const, Transient, EditConst)
	struct FString                                     LayerName;                                                // 0x0090(0x0010) (Edit, Transient, AlwaysInit, NeedCtorLink)
	TArray<int>                                        ChargeSkillLayerIndexArray;                               // 0x00A0(0x0010) (AlwaysInit, NeedCtorLink)
	int                                                EditorSkillTierIndex1;                                    // 0x00B0(0x0004) (Edit, Transient)
	int                                                EditorSkillTierIndex2;                                    // 0x00B4(0x0004) (Edit, Transient)
	int                                                EditorSkillTierIndex3;                                    // 0x00B8(0x0004) (Edit, Transient)
...
public:
	...
	struct FString                                     Category;                                                 // 0x0094(0x0010) (Edit, NeedCtorLink)
	struct FString                                     GroupName;                                                // 0x00A4(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	struct FString                                     PackageName;                                              // 0x00B4(0x0010) (Edit, EditConst, AlwaysInit, NeedCtorLink)
	struct FString                                     LookInfoKey;                                              // 0x00C4(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	TArray<class UAnimSet*>                            ReferenceAnimSetList;                                     // 0x00D4(0x0010) (Edit, Transient, NeedCtorLink)
	struct FString                                     Comment;                                                  // 0x00E4(0x0010) (Edit, AlwaysInit, NeedCtorLink)
	class UEFActionObjectGroup*                        Template;                                                 // 0x00F4(0x0008) (Edit, AlwaysInit)
	TArray<class UEFActionObject*>                     ActionList;                                               // 0x00FC(0x0010) (AlwaysInit, NeedCtorLink)
	unsigned long                                      bNpcPartInfoExport : 1;                                   // 0x010C(0x0004) (Edit)
	unsigned long                                      SetStageTransitionInfoComplete : 1;                       // 0x010C(0x0004)
	unsigned long                                      SetNpcDestructionPartsRadiusInfoComplete : 1;             // 0x010C(0x0004)
	TArray<struct FEFActionGroupReference>             ActionGroupReferenceList;                                 // 0x0110(0x0010) (Edit, Transient, NeedCtorLink)
...
{
public:
	TArray<struct FEFSkill_NotifyGroup>                NotifyGroupList;                                          // 0x0050(0x0010) (AlwaysInit, NeedCtorLink)
	struct FEFSkill_NotifyGroup                        AnimGroup;                                                // 0x0060(0x0018) (NeedCtorLink)
	float                                              ViewPosX;                                                 // 0x0078(0x0004) (Edit)
	float                                              ViewPosY;                                                 // 0x007C(0x0004) (Edit)
	unsigned long                                      Differ : 1;                                               // 0x0080(0x0004)
	unsigned long                                      InfiniteStage : 1;                                        // 0x0080(0x0004) (Edit)
	unsigned long                                      AtkSpeedStage : 1;                                        // 0x0080(0x0004) (Edit)
	unsigned long                                      bTimingBarReverse : 1;                                    // 0x0080(0x0004) (Edit)
	unsigned long                                      bTestTimingBarCategory : 1;                               // 0x0080(0x0004) (Edit)
	unsigned long                                      EnableESCCancel : 1;                                      // 0x0080(0x0004) (Edit)
	unsigned long                                      EnableStageBuff : 1;                                      // 0x0080(0x0004) (Edit)
	unsigned long                                      bUseAimOffset : 1;                                        // 0x0080(0x0004) (Edit)
	unsigned long                                      bUsePreviousStageMouseTargetPos : 1;                      // 0x0080(0x0004) (Edit)
	unsigned long                                      AnimError : 1;                                            // 0x0080(0x0004)
	unsigned long                                      bNpcPartInfoExportStage : 1;                              // 0x0080(0x0004) (Edit)
	unsigned long                                      bChargeScaleStage : 1;                                    // 0x0080(0x0004) (Edit)
	struct FString                                     StageName;                                                // 0x0084(0x0010) (Edit, NeedCtorLink)
	float                                              StageLength;                                              // 0x0094(0x0004) (Edit)
	float                                              StagePlayRate;                                            // 0x0098(0x0004) (Edit)
	TEnumAsByte<EFSTAGE_TIMINGBARTYPE>                 TimingBarType;                                            // 0x009C(0x0001) (Edit)
	TEnumAsByte<EFSTAGE_TIMINGBARTEXTTYPE>             TimingBarTextType;                                        // 0x009D(0x0001) (Edit)
	TEnumAsByte<EFSTAGE_TIMINGBARCATEGORY>             TestTimingBarCategory;                                    // 0x009E(0x0001) (Edit)
	TEnumAsByte<EFSTAGE_CHANGEDIRTYPE>                 StageChangeDirType;                                       // 0x009F(0x0001) (Edit)
	TEnumAsByte<EFSTAGE_MOVEPOSTYPE>                   StageChangeMovePosType;                                   // 0x00A0(0x0001) (Edit)
	TEnumAsByte<ESkipCollidePawnType>                  SkipPawnCollision;                                        // 0x00A1(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x2];                                       // 0x00A2(0x0002) MISSED OFFSET
	int                                                NextStageIndex;                                           // 0x00A4(0x0004) (Edit)
	int                                                StageBuffId;                                              // 0x00A8(0x0004) (Edit)
	float                                              StageChangeDirInterpolationTime;                          // 0x00AC(0x0004) (Edit)
	int                                                StageChangeDirLimitDegree;                                // 0x00B0(0x0004) (Edit)
	float                                              MovePosValue;                                             // 0x00B4(0x0004) (Edit)
	float                                              MovePosOffsetValue;                                       // 0x00B8(0x0004) (Edit)
	TArray<class UEFAction_Notify*>                    NotifyList;                                               // 0x00BC(0x0010) (AlwaysInit, NeedCtorLink)
	int                                                AnimNotifyIndex;                                          // 0x00CC(0x0004)
	struct FVector                                     MaxRootMotionDelta;                                       // 0x00D0(0x000C) (Edit)
	struct FVector                                     MinRootMotionDelta;                                       // 0x00DC(0x000C) (Edit)
	float                                              RootMotionSampleTime;                                     // 0x00E8(0x0004) (Edit, DuplicateTransient)
	TArray<struct FVector>                             RootMotionSample;                                         // 0x00EC(0x0010) (Edit, DuplicateTransient, NeedCtorLink)
	TArray<int>                                        RootMotionRotationYawSample;                              // 0x00FC(0x0010) (Edit, DuplicateTransient, NeedCtorLink)
	float                                              StageCancelTime;                                          // 0x010C(0x0004) (Edit, EditConst)
	int                                                ChargeParticleScale;                                      // 0x0110(0x0004) (Edit)
	int                                                ChargeDamageScale;                                        // 0x0114(0x0004) (Edit)
	struct FEFStageTransitionInfo                      StageTransitionInfo;                                      // 0x0118(0x000C)
...
public:
	...
	unsigned long                                      bSwitchCharacterAKEvent : 1;                              // 0x0158(0x0004) (Edit)
	unsigned long                                      StopWhenBaseDestroy : 1;                                  // 0x0158(0x0004) (Edit)
	float                                              StopWhenBaseDestroyFadeTime;                              // 0x015C(0x0004) (Edit)
...
public:
	...
	class UEFProjectileParticleData*                   ExplodeParticleData;                                      // 0x0154(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	class UEFProjectileParticleData*                   EnvExplodeParticleData;                                   // 0x015C(0x0008) (Edit, ExportObject, NeedCtorLink, EditInline)
	float                                              ResScale;                                                 // 0x0164(0x0004) (Edit)
	float                                              CollisionSize;                                            // 0x0168(0x0004) (Edit)
	float                                              CollisionSize_HeightClientOnly;                           // 0x016C(0x0004) (Edit)
	int                                                Speed;                                                    // 0x0170(0x0004) (Edit)
	int                                                MaxSpeed;                                                 // 0x0174(0x0004) (Edit)
	float                                              Lifetime;                                                 // 0x0178(0x0004) (Edit)
	int                                                MaxDistance;                                              // 0x017C(0x0004) (Edit)
	int                                                MaxApplyCount;                                            // 0x0180(0x0004) (Edit)
	struct FEFSummonsObjectMask                        ObjectMask;                                               // 0x0184(0x0004) (Edit)
	int                                                ObjectMaskValue;                                          // 0x0188(0x0004)
...
public:
	...
	unsigned long                                      bDecalOverPrevent : 1;                                    // 0x0200(0x0004) (Edit)
	unsigned long                                      bInitialLocGround : 1;                                    // 0x0200(0x0004) (Edit)
...
public:
	...
	float                                              fWaitTime;                                                // 0x01E8(0x0004) (Edit)
	float                                              fNoCollisionTime;                                         // 0x01EC(0x0004) (Edit)
...
public:
	...
	unsigned long                                      bIsIgnoreBGround : 1;                                     // 0x01D4(0x0004) (Edit)
	...
	TEnumAsByte<ETraceProjectileTargetOptionType>      TraceTargetOption;                                        // 0x01DB(0x0001) (Edit)
...
public:
	...
	TArray<class UEFSequenceSummonsEditorFilterData*>  SubFilters;                                               // 0x01D0(0x0010) (ExportObject, Transient, AlwaysInit, NeedCtorLink, EditInline)
...
public:
	...
	int                                                GroupActorIndex;                                          // 0x00C0(0x0004) (Transient)
	struct FEFFacialAnimInfo                           FacialAnimInfo;                                           // 0x00C4(0x0010) (Edit)
	unsigned long                                      bApplyFacialAnim : 1;                                     // 0x00D4(0x0004) (Transient)
	int                                                PrevKeyIndex;                                             // 0x00D8(0x0004) (Transient)
