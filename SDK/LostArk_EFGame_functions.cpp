...
bool UEFConsole::InputKey(int* ControllerId, struct FName* Key, TEnumAsByte<EInputEvent>* Event, float* AmountDepressed, bool* bGamepad)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.ClearManagedSpawnParts");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.ClearAttachedPSIIndex");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.NotifyChangedBase");
...
void AEFFracturedStaticMeshActor::BreakOffPartsInRadius(struct FVector* Origin, float* Radius, float* RBStrength, bool* bWantPhysChunksAndParticles)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.BreakOffPartsInRadius");
...
void AEFFracturedStaticMeshActor::BreakOffIsolatedIslands(TArray<int>* IgnoreFrags, struct FVector* ChunkDir, TArray<class AFracturedStaticMeshPart*>* DisableCollWithPart, bool* bWantPhysChunks, TArray<unsigned char>* FragmentVis)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.BreakOffIsolatedIslands");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.SpawnDeferredParts");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.Explode");
...
void AEFFracturedStaticMeshActor::TakeDamage(int* Damage, class AController** EventInstigator, struct FVector* HitLocation, struct FVector* Momentum, class UClass** DamageType, struct FTraceHitInfo* HitInfo, class AActor** DamageCauser)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.TakeDamage");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.BaseChange");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.Destroyed");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshActor.PostBeginPlay");
...
void AEFFracturedStaticMeshPart::BreakOffPartsInRadius(struct FVector* Origin, float* Radius, float* RBStrength, bool* bWantPhysChunksAndParticles)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.BreakOffPartsInRadius");
...
void AEFFracturedStaticMeshPart::BreakOffIsolatedIslands(TArray<int>* IgnoreFrags, struct FVector* ChunkDir, TArray<class AFracturedStaticMeshPart*>* DisableCollWithPart, bool* bWantPhysChunks, TArray<unsigned char>* FragmentVis)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.BreakOffIsolatedIslands");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.SpawnDeferredParts");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.Explode");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.DoExplode");
...
void AEFFracturedStaticMeshPart::TakeDamage(int* Damage, class AController** EventInstigator, struct FVector* HitLocation, struct FVector* Momentum, class UClass** DamageType, struct FTraceHitInfo* HitInfo, class AActor** DamageCauser)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.TakeDamage");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.PostBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.RecyclePart");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFFracturedStaticMeshPart.Initialize");
...
class APlayerController* AEFGameInfo::Login(struct FString* Portal, struct FString* Options, struct FUniqueNetId* UniqueId, struct FString* ErrorMessage)
{
...
void AEFPawn::Landed(struct FVector* HitNormal, class AActor** FloorActor)
{
...
bool AEFPawn::SetDesiredRotation(struct FRotator* TargetDesiredRotation, bool* InLockDesiredRotation, bool* InUnlockWhenReached, float* InterpolationTime, bool* bResetRotationRate)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFPlayerController.ModifyOnSetCameraTargetBlendTime");
...
struct FString AEFPlayerController::ConsoleCommand(struct FString* Command, bool* bWriteToLog)
{
...
void AEFProjectile::ProcessTouch(class AActor** Other, class UPrimitiveComponent** OtherComp, struct FVector* HitLocation, struct FVector* HitNormal)
{
...
void AEFVolume::Touch(class AActor** Other, class UPrimitiveComponent** OtherComp, struct FVector* HitLocation, struct FVector* HitNormal)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.OnBecomeInActive");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.OnBecomeActive");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.InitCameraSetting");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.ChangeZoomStep");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.CheckZoom");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.ZoomOut");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.ZoomIn");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.UpdateCamera");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFSideViewCamera.ResetInterpolation");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.OnBecomeInActive");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.OnBecomeActive");
...
// (Native, HasOptionalParms, Public)
// Parameters:
// TEnumAsByte<ETownCameraMode>   InType                         (Parm)
// bool                           InForce                        (OptionalParm, Parm)

void UEFTownCamera::ChangeTownCameraType(TEnumAsByte<ETownCameraMode> InType, bool InForce)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.ChangeTownCameraType");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.InActivateTownCamera");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.ActivateTownCamera");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.InActivateSkeletalMeshForceLOD");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.ActivateSkeletalMeshForceLOD");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.ChangeZoomStep");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.CheckZoom");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.ZoomOut");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.ZoomIn");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.UpdateCamera");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTownCamera.ResetInterpolation");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFPlayerCamera.UpdatePlayerOccludingTownPlacementActors");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFPlayerCamera.ClearCameraActorGrabInterp");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFPlayerCamera.ApplyCameraActorGrabInterp");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFPlayerCamera.ModifyOnSetCameraTargetBlendTime");
...
void AEFChangePlayerCameraVolume::Touch(class AActor** Other, class UPrimitiveComponent** OtherComp, struct FVector* HitLocation, struct FVector* HitNormal)
{
...
void AEFEnvironmentInfoVolume::Touch(class AActor** Other, class UPrimitiveComponent** OtherComp, struct FVector* HitLocation, struct FVector* HitNormal)
{
...
bool UEFGFxMoviePlayer::WidgetUnloaded(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
bool UEFGFxMoviePlayer::WidgetInitialized(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxMovieWidgetMain.IsRegisteredWidget");
...
bool UEFGFxMovieWidgetMain::WidgetUnloaded(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
bool UEFGFxMovieWidgetMain::WidgetInitialized(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxMovieWidgetMain.ComponentMagnetRectangle");
...
bool UEFUIComponent::WidgetInitialized(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUIListItemSlot.SetIslandIcon");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUIListItemSlot.SetTripodBookmarkShow");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUIListItemSlot.SetEngraveBookmarkShow");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetColorPicker.RequestEventColorPickerTextInputChange");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetGuild.GuildPassword");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetGuild.GuildJoinImmediately");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetSkillBook.DevSkillBookTierBtnClick");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetSystemOption.SystemOptionListBoxIndexChange");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetSystemOption.SystemOptionAutoInputTextChange");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetSystemOption.SystemOptionAutoInputHideCloseBtn");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetSystemOption.SystemOptionAutoInputFocusOut");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGFxWidgetSystemOption.SystemOptionAutoInputFocusIn");
...
bool UEFUIFrame::WidgetInitialized(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUIFrame.IsRegisteredWidget");
...
bool UEFGFxWidgetCommon::WidgetInitialized(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
bool UEFGFxWidgetInteraction::WidgetInitialized(struct FName* WidgetName, struct FName* WidgetPath, class UGFxObject** Widget)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUISlotData.SetPresetGemIcon");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUISlotData.SetSortLocked");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUISlotData.SetItemLevelString");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUISlotData.SetRightTopString");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUISlotData.SetIslandIcon");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUISlotData.SetTripodBookmarkShow");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFUISlotData.SetEngraveBookmarkShow");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGameViewportClient.PostFullScreenFilterRender");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGameViewportClient.PostFullScreenRender");
...
// Function EFGame.EFGameViewportClient.DrawSpinnerUI
// (Final, Native, Private)
// Parameters:
// class UCanvas*                 Canvas                         (Parm)

void UEFGameViewportClient::DrawSpinnerUI(class UCanvas* Canvas)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGameViewportClient.DrawSpinnerUI");

	UEFGameViewportClient_DrawSpinnerUI_Params params;
	params.Canvas = Canvas;
...
// Function EFGame.EFGameViewportClient.HideSpinnerUI
// (Native, Public)

void UEFGameViewportClient::HideSpinnerUI()
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGameViewportClient.HideSpinnerUI");

	UEFGameViewportClient_HideSpinnerUI_Params params;
...
// Function EFGame.EFGameViewportClient.ShowSpinnerUIWhileFadedOut
// (Native, Public)

void UEFGameViewportClient::ShowSpinnerUIWhileFadedOut()
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFGameViewportClient.ShowSpinnerUIWhileFadedOut");

	UEFGameViewportClient_ShowSpinnerUIWhileFadedOut_Params params;
...
void AEFLocalTrigger::Touch(class AActor** Other, class UPrimitiveComponent** OtherComp, struct FVector* HitLocation, struct FVector* HitNormal)
{
...
void AEFLocalTriggerVolume::Touch(class AActor** Other, class UPrimitiveComponent** OtherComp, struct FVector* HitLocation, struct FVector* HitNormal)
{
...
bool UEFDataContainer_CharacterCustomizing::XmlExport(struct FString* strPath, struct FString* strErrorMsg)
{
...
bool UEFDataContainer_ColorPalette::XmlExport(struct FString* strPath, struct FString* strErrorMsg)
{
...
bool UEFDataContainer_CustomizeBoneScale::XmlExport(struct FString* strPath, struct FString* strErrorMsg)
{
...
bool UEFDataContainer_LookInfos::XmlExport(struct FString* strPath, struct FString* strErrorMsg)
{
...
bool UEFDataContainer_NpcFunction::XmlExport(struct FString* strPath, struct FString* strErrorMsg)
{
...
bool UEFDataContainer_Quest::XmlExport(struct FString* strPath, struct FString* strErrorMsg)
{
...
bool UEFDataContainer_TexturePalette::XmlExport(struct FString* strPath, struct FString* strErrorMsg)
{
...
void AEFInteractiveFoliageActor::TakeDamage(int* Damage, class AController** EventInstigator, struct FVector* HitLocation, struct FVector* Momentum, class UClass** DamageType, struct FTraceHitInfo* HitInfo, class AActor** DamageCauser)
{
...
void UEFTexture2DDynamic::UpdateMipFromPNG(int MipIdx, bool UseBoardA, TArray<unsigned char>* MipData)
{
	static auto fn = UObject::FindObject<UFunction>("Function EFGame.EFTexture2DDynamic.UpdateMipFromPNG");
