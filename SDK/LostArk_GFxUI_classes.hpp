...
public:
	...
	unsigned char                                      UnknownData03[0x48];                                      // 0x0170(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetBindingMaps
	unsigned char                                      UnknownData04[0x48];                                      // 0x01B8(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	class UGFxObject*                                  SplitscreenLayoutObject;                                  // 0x0200(0x0008) (Transient)
	int                                                SplitscreenLayoutYAdjust;                                 // 0x0208(0x0004) (Config)
	TArray<class UGFxObject*>                          DebugArray;                                               // 0x020C(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                // 0x021C(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x4];                                       // 0x021C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData00[0x48];                                      // 0x00A0(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxObject.SubWidgetBindingMaps
	unsigned long                                      bListenExternalInterfaceCall : 1;                         // 0x00E8(0x0004)
...
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                                // 0x00EC(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00EC(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	bool FSCommand(class UGFxMoviePlayer** Movie, class UGFxEvent_FSCommand** Event, struct FString* Cmd, struct FString* Arg);
};
