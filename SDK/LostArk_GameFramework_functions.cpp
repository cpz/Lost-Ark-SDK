...
void AGameCrowdAgentSkeletal::SetLighting(bool* bEnableLightEnvironment, struct FLightingChannelContainer* AgentLightingChannel, bool* bCastShadows)
{
...
void AGameCrowdBehaviorPoint::Touch(class AActor** Other, class UPrimitiveComponent** OtherComp, struct FVector* HitLocation, struct FVector* HitNormal)
{
...
struct FString ADebugCameraController::ConsoleCommand(struct FString* Command, bool* bWriteToLog)
{
...
void UMobilePlayerInput::PreClientTravel(struct FString* PendingURL, TEnumAsByte<ETravelType>* TravelType, bool* bIsSeamlessTravel)
{
...
void UGameAICmd_Hover_MoveToGoal_Mesh::DrawDebug(class AHUD** H, struct FName* Category)
{
...
class APlayerController* APlayerCollectorGame::Login(struct FString* Portal, struct FString* Options, struct FUniqueNetId* UniqueId, struct FString* ErrorMessage)
{
