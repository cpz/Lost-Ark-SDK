...
{
	TArray<struct FEFInputStateFlow>                   FlowList;                                                 // 0x0000(0x0010)
};
...
{
	TArray<struct FSettingsData>                       aSettingDatas;                                            // 0x0000(0x0010)
};
...
{
	TArray<class UParticleSystemComponent*>            ActivePSC;                                                // 0x0000(0x0010)
};
...
{
	TArray<struct FString>                             ReceiverArr;                                              // 0x0000(0x0010)
};
...
{
	TArray<struct FNpcPartExtentInfo>                  NpcPartExtentInfoArray;                                   // 0x0000(0x0010)
};
...
{
	TArray<struct FActionNpcPartTransformInfo>         ActionNpcPartTransformInfoArray;                          // 0x0000(0x0010)
};
...
{
	TArray<unsigned char>                              HitTestPixels;                                            // 0x0000(0x0010)
};
