...
public:
	...
	unsigned long                                      bLocalVoiceSwitch : 1;                                    // 0x00C0(0x0004) (Edit)
...
{
public:
	unsigned long                                      Async : 1;                                                // 0x016C(0x0004) (Edit)
	unsigned long                                      bWaitingCallback : 1;                                     // 0x016C(0x0004) (Transient)
...
public:
	...
	unsigned long                                      Running : 1;                                              // 0x0180(0x0004) (Transient)
