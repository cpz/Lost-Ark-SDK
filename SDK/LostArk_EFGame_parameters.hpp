...
struct UEFGameViewportClient_DrawSpinnerUI_Params
{
	class UCanvas*                                     Canvas;                                                   // (Parm)
};

// Function EFGame.EFGameViewportClient.HideSpinnerUI
struct UEFGameViewportClient_HideSpinnerUI_Params
{
};

// Function EFGame.EFGameViewportClient.ShowSpinnerUIWhileFadedOut
struct UEFGameViewportClient_ShowSpinnerUIWhileFadedOut_Params
{
};
